# 0 - THE BEST OF THE BEST RESOURCE
...
* It would be helpful to replicate the code in the video by writing and running the code in a Jupyter Notebook
...
* For this project:
    * We will store all data in data frames
